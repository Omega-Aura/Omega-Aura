...
* **Data Structures & Algorithms** - Greedy, Searching, Sorting
* **Object-Oriented Programming** - Clean code principles
* **Time & Space Complexity** - Algorithmic thinking
* **Problem Solving Mindset** - Competitive programming focus
* **Machine Learning in Biology** - Basics and applications
